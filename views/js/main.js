...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    switch(size) {
     ...
     var randomPizzaSize = document.querySelectorAll(".randomPizzaContainer");
    for (var i = 0; i < randomPizzaSize .length; i++) {
          randomPizzaSize[i].style.width = newwidth+ "%";
    }
  }
...
// move the element out the for stetment
...
function updatePositions() {
  ...
  var scrollTopBody =document.body.scrollTop;
  var items = document.querySelectorAll('.mover');
  for (var i = 0; i < items.length; i++) {
    var phase = Math.sin((scrollTopBody / 1250) + (i % 5));
